...
import (
	...
	"github.com/triarius/goreleaser/internal/pipe/announce"
	"github.com/triarius/goreleaser/internal/pipe/archive"
	"github.com/triarius/goreleaser/internal/pipe/aur"
	"github.com/triarius/goreleaser/internal/pipe/before"
	"github.com/triarius/goreleaser/internal/pipe/brew"
	"github.com/triarius/goreleaser/internal/pipe/build"
	"github.com/triarius/goreleaser/internal/pipe/changelog"
	"github.com/triarius/goreleaser/internal/pipe/checksums"
	"github.com/triarius/goreleaser/internal/pipe/defaults"
	"github.com/triarius/goreleaser/internal/pipe/dist"
	"github.com/triarius/goreleaser/internal/pipe/docker"
	"github.com/triarius/goreleaser/internal/pipe/effectiveconfig"
	"github.com/triarius/goreleaser/internal/pipe/env"
	"github.com/triarius/goreleaser/internal/pipe/git"
	"github.com/triarius/goreleaser/internal/pipe/gomod"
	"github.com/triarius/goreleaser/internal/pipe/krew"
	"github.com/triarius/goreleaser/internal/pipe/metadata"
	"github.com/triarius/goreleaser/internal/pipe/nfpm"
	"github.com/triarius/goreleaser/internal/pipe/prebuild"
	"github.com/triarius/goreleaser/internal/pipe/publish"
	"github.com/triarius/goreleaser/internal/pipe/sbom"
	"github.com/triarius/goreleaser/internal/pipe/scoop"
	"github.com/triarius/goreleaser/internal/pipe/semver"
